...
export default async function PrivacyPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <h1 className="font-display text-4xl font-semibold text-char-900">Privacy Policy</h1>
      ...
      <div className="prose-content mt-8 space-y-6 text-char-700">
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">1. Who we are</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">2. Information we collect</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">3. How we use it</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">4. Sharing your data</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">5. Your rights</h2>
          <p className="mt-2">
