...
export default async function TermsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <h1 className="font-display text-4xl font-semibold text-char-900">Terms &amp; Conditions</h1>
      ...
      <div className="mt-8 space-y-6 text-char-700">
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">1. Orders</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">2. Collection &amp; delivery times</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">3. Payment</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">4. Cancellations &amp; refunds</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-char-900">5. Allergens</h2>
          <p className="mt-2">
